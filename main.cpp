    ...
    try
    {
        ...
        if (argc == 1)
        {
            ...
            else
            {
                ...
                if (input == "insert")
                {
                    core::inputtask myinput;
                    myinput.insert();
                }
                else if (input == "insert-tag")
                {
                    core::taghandler mytaghandler;
                    mytaghandler.inputtag();
                }
                else if (input == "showurgent")
                {
                    core::outputtask myoutput;
                    myoutput.showUrgent();
                }
                else if (input == "showimportant")
                {
                    core::outputtask myoutput;
                    myoutput.showImportant();
                }
                else if (input == "shownoturgent")
                {
                    core::outputtask myoutput;
                    myoutput.shownotUrgent();
                }
                else if (input == "shownotimportant")
                {
                    core::outputtask myoutput;
                    myoutput.shownotImportant();
                }
                else if (input == "showurgentimportant")
                {
                    core::outputtask myoutput;
                    myoutput.showUrgentImportant();
                }
                else if (input == "showurgentnotimportant")
                {
                    core::outputtask myoutput;
                    myoutput.showUrgentnotImportant();
                }
                else if (input == "shownoturgentimportant")
                {
                    core::outputtask myoutput;
                    myoutput.shownotUrgentImportant();
                }
                else if (input == "shownoturgentnotimportant")
                {
                    core::outputtask myoutput;
                    myoutput.shownotUrgentnotImportant();
                }
